...
public class SearchUserClient {
	...
	public static void main(String[] args) throws IOException {
		...
		Discovery discovery = new Discovery(Discovery.DISCOVERY_ADDR, "host",  InetAddress.getLocalHost().getHostAddress());
		discovery.start();
		System.out.println("** Host Discovery Started **");

		URI[] uris = discovery.knownUrisOf("usrsrv");

		while(uris == null){
			try {
				System.out.println("Did Not Found the Server, Trying again in 2sec");
				Thread.sleep(2000);
				uris = discovery.knownUrisOf("usrsrv");
